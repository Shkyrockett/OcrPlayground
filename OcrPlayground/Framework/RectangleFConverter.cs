// <copyright file="RectangleFConverter.cs" company="Shkyrockett" >
...
namespace OCRPlayground
{
        ...
        : ExpandableObjectConverter
    {
        ...
        /// </summary>
        /// <param name="context">Provides contextual information required for conversion.
        ...
        /// Also, properties on the context object may also return null.</param>
        /// <param name="sourceType">The type of the source that is being evaluated for conversion.</param>
        /// <returns>
        /// true if the type can be converted to a <see cref="RectangleF" />; otherwise, false.
        /// </returns>
        ...
        /// Also, properties on the context object can also return null.</param>
        /// <param name="destinationType">The desired type this <see cref="RectangleF" /> is being evaluated for conversion.</param>
        /// <returns>
        /// true if a <see cref="RectangleF" /> can be converted to <paramref name="destinationType" />; otherwise, false.
        /// </returns>
        public override bool CanConvertTo(ITypeDescriptorContext? context, Type? destinationType) => destinationType == typeof(string) || base.CanConvertTo(context, destinationType);

        /// <summary>
        /// Attempts to convert the specified object to a <see cref="RectangleF" />.
        /// </summary>
        ...
        /// <returns>
        /// The <see cref="RectangleF" /> created from converting <paramref name="value" />.
        /// </returns>
        ...
        /// <summary>
        /// Attempts to convert a <see cref="RectangleF" /> to the specified type.
        /// </summary>
        /// <param name="context">Provides contextual information required for conversion.</param>
        ...
        /// <returns>
        /// The object created from converting this <see cref="RectangleF" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">destinationType</exception>
        /// <exception cref="NotSupportedException"><paramref name="value" /> is null.- or - <paramref name="value" /> is not a <see cref="RectangleF" />.- or - The <paramref name="destinationType" /> is not one of the valid types for conversion.</exception>
